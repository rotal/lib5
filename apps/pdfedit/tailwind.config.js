...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Sophisticated obsidian dark theme
        'surface': {
          '50': '#f8fafc',
          '100': '#f1f5f9',
          '200': '#e2e8f0',
        ...
        // Accent coral/salmon for warmth against dark
        'accent': {
          '50': '#fff7ed',
          '100': '#ffedd5',
          '200': '#fed7aa',
        ...
        // Warm amber for modified/warning
        'modified': {
          '300': '#fcd34d',
          '400': '#fbbf24',
          '500': '#f59e0b',
      ...
      boxShadow: {
        ...
        'button': '0 2px 8px rgba(0, 0, 0, 0.3), 0 1px 2px rgba(0, 0, 0, 0.2)',
