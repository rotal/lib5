  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Panel toggle button (right) */}
        <button
          onClick={toggleRightPanel}
          className="w-4 flex-shrink-0 bg-editor-surface hover:bg-editor-surface-light border-l border-editor-border flex items-center justify-center text-editor-text-dim hover:text-editor-text transition-colors"
        >
          <svg
